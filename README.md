...
1. Clone the base boilerplate in the folder **assignment-solution-step6** of your local machine
    ...
    `git clone https://gitlab-ust.stackroute.in/stack_java_keep/KeepNote-Step6-Boilerplate.git assignment-solution-step6`
...
5. Add your new repository reference as remote
     ...
     `git remote add origin https://gitlab-ust.stackroute.in/{{yourusername}}/assignment-solution-step6`
